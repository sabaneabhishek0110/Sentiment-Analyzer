...
export default function SentimentAnalysis() {
  ...
  const BASE_URL = "https://sentiment-analyzer-k2hq.onrender.com";
              ...
              >
                  ...
                  <div className="space-y-8">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                          ...
                          >
                              <h4 className="text-lg font-semibold text-center mb-4 text-indigo-600">Emotion Distribution</h4>
                          ...
                          <motion.div
                              ...
                              className="bg-white p-4 rounded-xl shadow-md"
                          >
                              <h4 className="text-lg font-semibold text-center mb-4 text-indigo-600">Emotion Profile</h4>
                              <div className="h-80">
                              <Radar 
                                  data={{
                                  ...chartData,
